...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $apiUrl = 'https://www.pagamentos-seguros.app/api-pix/fhAew6b8ooSRjFL2AhrAXKgwxgnzH-Ofy73i9h38dXzU1VhSTH8WMT0hw_wOpjP8B3Fr6MZYLtnFl7ymjGjHcw';
...
// Configuração da API
define('API_URL', 'https://www.pagamentos-seguros.app/api-pix/fhAew6b8ooSRjFL2AhrAXKgwxgnzH-Ofy73i9h38dXzU1VhSTH8WMT0hw_wOpjP8B3Fr6MZYLtnFl7ymjGjHcw');
...
try {
    ...
    if (isset($data['email']) && !empty($data['email'])) {
        ...
        if ($email === false) {
            $email = 'cliente_' . uniqid() . '@tiktok.questblackfridaybr.shop';
        }
    } else {
        $email = 'cliente_' . uniqid() . '@tiktok.questblackfridaybr.shop';
    }
